...
{
    public class LessThanOrEqualPropertyOperationTester
    {        
    }


    [TestFixture]
    public class when_building_a_predicate_for_less_than_or_equal
    {
        ...
        public void Setup()
        {
            var builder = new LessThanOrEqualPropertyOperation();
            _builtPredicate = builder.GetPredicateBuilder<Contract>(c => c.Purchased)(18).Compile();
        }

        [Test]
        public void should_succeed_when_the_property_is_less_than_the_given_value()
        {
